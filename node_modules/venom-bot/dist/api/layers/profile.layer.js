...
class ProfileLayer extends host_layer_1.HostLayer {
    ...
    async delProfile() {
        if (!this.page.isClosed()) {
            ...
            const folderSession = path.join(path.resolve(process.cwd(), this.options.mkdirFolderToken, this.options.folderNameToken, this.options.mkdirFolderTokenMultidevice, this.session));
